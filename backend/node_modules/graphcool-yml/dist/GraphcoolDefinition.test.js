...
function makeDefinition(yml, datamodel, args, globalRC, envVars) {
    ...
    var definitionPath = path.join(definitionDir, 'graphcool.yml');
    var modelPath = path.join(definitionDir, 'datamodel.graphql');
    var env = Environment_test_1.makeEnv(defaultGlobalRC);
    var definition = new GraphcoolDefinition_1.GraphcoolDefinitionClass(env, definitionPath, envVars);
...
describe('graphcool definition', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    definition = new GraphcoolDefinition_1.GraphcoolDefinitionClass(env, definitionPath, {
...
//# sourceMappingURL=GraphcoolDefinition.test.js.map