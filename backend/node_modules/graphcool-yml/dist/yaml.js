        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!valid) {
                        debugger;
                        errorMessage = "Invalid graphcool.yml file" + '\n' + printErrors(validate.errors);
...
function printErrors(errors, name) {
    if (name === void 0) { name = 'graphcool.yml'; }
    return errors
        .map(function (e) {
...
var betterMessagesByParams = {
    ...
    '{"additionalProperty":"stages"}': 'graphcool.yml should NOT have a "stages" property anymore. Stages are now just provided as CLI args.\nRead more here: https://goo.gl/SUD5i5',
    '{"additionalProperty":"types"}': 'graphcool.yml should NOT have a "types" property anymore. It has been renamed to "datamodel"',
};
