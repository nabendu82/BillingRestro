...
function mockServer(schema, mocks, preserveResolvers, seed) {
    ...
    addMockFunctionsToSchema({ schema: mySchema, mocks: mocks, preserveResolvers: preserveResolvers, seed: seed });
    return { query: function (query, vars) { return graphql_1.graphql(mySchema, query, {}, {}, vars); } };
}
exports.mockServer = mockServer;
var defaultMockMap = new Map();
defaultMockMap.set('Int', function () { return casual.integer(-100, 100); });
defaultMockMap.set('Float', function () { return casual.double(-100, 100); });
defaultMockMap.set('String', function () { return 'Hello World'; });
defaultMockMap.set('Boolean', function () { return casual.boolean; });
defaultMockMap.set('ID', function () { return casual.uuid; });
// TODO allow providing a seed such that lengths of list could be deterministic
// this could be done by using casual to get a random list length if the casual
// object is global.
function addMockFunctionsToSchema(_a) {
    var schema = _a.schema, _b = _a.mocks, mocks = _b === void 0 ? {} : _b, _c = _a.preserveResolvers, preserveResolvers = _c === void 0 ? false : _c, seed = _a.seed;
    if (!schema) {
    ...
    var mockType = function (type, typeName, fieldName) {
        ...
        return function (root, args, context, info) {
            ...
            if (fieldType instanceof graphql_1.GraphQLList) {
                return Array.from({ length: casual.integer(0, 10) }, function () {
