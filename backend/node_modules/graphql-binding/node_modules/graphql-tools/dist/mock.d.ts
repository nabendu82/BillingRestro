...
declare function mockServer(schema: GraphQLSchema | ITypeDefinitions, mocks: IMocks, preserveResolvers?: boolean, seed?: number): IMockServer;
declare function addMockFunctionsToSchema({schema, mocks, preserveResolvers, seed}: IMockOptions): void;
