...
// of this project.
function patchEndpointsToConfig(config, cwd, envVars) {
    return __awaiter(this, void 0, void 0, function () {
        var _a;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, getEndpointsFromPath(env, newConfig.extensions.prisma, cwd, envVars)];
                case 2:
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, getEndpointsFromPath(env, project.extensions.prisma, cwd, envVars)];
                                    case 1:
                                        _a.apply(void 0, _b.concat([_c.sent()]));
                                        _c.label = 2;
...
function makeConfigFromPath(cwd, envVars) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var ymlPath, home, env, definition, serviceName, stage, clusterName, cluster, url, token, headers, data, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
...
function getEndpointsFromPath(env, ymlPath, cwd, envVars) {
    return __awaiter(this, void 0, void 0, function () {
        var joinedYmlPath, definition, serviceName, stage, clusterName, cluster, url, token, headers, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
