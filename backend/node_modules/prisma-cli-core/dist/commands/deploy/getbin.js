...
function getBinPath(bin) {
    return __awaiter(this, void 0, void 0, function () {
        var paths, exist, existsIndex;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    paths = getPaths(bin);
                    return [4 /*yield*/, Promise.all(paths.map(function (p) { return fs.pathExists(p); }))];
                case 1:
                    exist = _a.sent();
                    existsIndex = exist.findIndex(function (e) { return e; });
                    if (existsIndex > -1) {
                        return [2 /*return*/, paths[existsIndex]];
                    }
