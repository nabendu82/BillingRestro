...
var UpgradeLocal = /** @class */ (function (_super) {
    __extends(UpgradeLocal, _super);
    function UpgradeLocal() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    UpgradeLocal.prototype.run = function () {
    ...
    UpgradeLocal.topic = 'local';
    UpgradeLocal.command = 'upgrade';
    UpgradeLocal.description = 'Upgrade to the latest (or specific) cluster version';
    UpgradeLocal.group = 'local';
    UpgradeLocal.flags = {
