...
var Playground = /** @class */ (function (_super) {
    ...
    Playground.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var web, envFile, serviceName, stage, clusterName, cluster, localPlaygroundPath, endpoint, envPath, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        endpoint = cluster.getApiEndpoint(this.definition.definition.service, stage);
