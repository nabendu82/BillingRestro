...
var ModelUpdateOneWithoutRelatedInputTypeGenerator = /** @class */ (function (_super) {
    ...
    ModelUpdateOneWithoutRelatedInputTypeGenerator.prototype.getTypeName = function (input, args) {
        ...
        return input.name + "UpdateOneRequiredWithout" + util_1.capitalize(field.name) + "Input";
    };
    ModelUpdateOneWithoutRelatedInputTypeGenerator.prototype.generateFields = function (model, args) {
        var fields = {};
        if (generator_1.TypeFromModelGenerator.hasFieldsExcept.apply(generator_1.TypeFromModelGenerator, [model.fields].concat(generator_1.TypeFromModelGenerator.reservedFields, [args.relatedField.relatedField.name]))) {
