...
var _1 = require("../");
ava_1.default('Middleware with generator', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
    var typeDefs, resolvers, schema, testMiddleware, schemaWithMiddleware, query, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                testMiddleware = _1.middleware(function (_schema) {
                ...
                schemaWithMiddleware = _1.applyMiddleware(schema, testMiddleware);
                query = "\n    query {\n      test\n    }\n  ";
