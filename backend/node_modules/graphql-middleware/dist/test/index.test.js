...
ava_1.default('Type middleware - Query after', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                schema = getSchema();
                schemaWithMiddleware = _1.applyMiddleware(schema, typeMiddlewareAfter);
                query = "\n    query {\n      before(arg: \"before\")\n      beforeNothing(arg: \"before\")\n      after\n      afterNothing\n      null\n      nested { nothing }\n    }\n  ";
                return [4 /*yield*/, graphql_1.graphql(schemaWithMiddleware, query)];
            case 1:
                res = _a.sent();
...
ava_1.default('Schema middleware - Query before', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                schema = getSchema();
                schemaWithMiddleware = _1.applyMiddleware(schema, schemaMiddlewareBefore);
                query = "\n    query {\n      before(arg: \"before\")\n      beforeNothing(arg: \"before\")\n      after\n      afterNothing\n      null\n      nested { nothing }\n    }\n  ";
                return [4 /*yield*/, graphql_1.graphql(schemaWithMiddleware, query)];
            case 1:
                res = _a.sent();
...
ava_1.default('Schema middleware - Query after', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                schema = getSchema();
                schemaWithMiddleware = _1.applyMiddleware(schema, schemaMiddlewareAfter);
                query = "\n    query {\n      before(arg: \"before\")\n      beforeNothing(arg: \"before\")\n      after\n      afterNothing\n      null\n      nested { nothing }\n    }\n  ";
                return [4 /*yield*/, graphql_1.graphql(schemaWithMiddleware, query)];
            case 1:
                res = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                schemaWithMiddleware = _1.applyMiddleware(schema, schemaMiddleware, fieldMiddleware, typeMiddleware);
