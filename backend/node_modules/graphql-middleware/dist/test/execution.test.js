    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                schemaWithMiddleware = _1.applyMiddleware(schema, firstMiddleware(t), secondMiddleware(t));
                query = "\n    query {\n      test\n    }\n  ";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                schemaWithMiddleware = _1.applyMiddleware(schema, middleware);
                query = "\n    query {\n      test(arg: \"fail\") {\n        parent\n      }\n    }\n  ";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                schemaWithMiddleware1 = _1.applyMiddleware(graphql_tools_1.makeExecutableSchema({ typeDefs: typeDefs, resolvers: resolvers }), schemaMiddleware, fieldMiddleware, typeMiddleware);
                schemaWithMiddleware2 = _1.applyMiddleware(graphql_tools_1.makeExecutableSchema({ typeDefs: typeDefs, resolvers: resolvers }), schemaMiddleware, typeMiddleware, fieldMiddleware);
                schemaWithMiddleware3 = _1.applyMiddleware(graphql_tools_1.makeExecutableSchema({ typeDefs: typeDefs, resolvers: resolvers }), typeMiddleware, schemaMiddleware, fieldMiddleware);
                schemaWithMiddleware4 = _1.applyMiddleware(graphql_tools_1.makeExecutableSchema({ typeDefs: typeDefs, resolvers: resolvers }), typeMiddleware, fieldMiddleware, schemaMiddleware);
                schemaWithMiddleware5 = _1.applyMiddleware(graphql_tools_1.makeExecutableSchema({ typeDefs: typeDefs, resolvers: resolvers }), fieldMiddleware, schemaMiddleware, typeMiddleware);
                schemaWithMiddleware6 = _1.applyMiddleware(graphql_tools_1.makeExecutableSchema({ typeDefs: typeDefs, resolvers: resolvers }), fieldMiddleware, typeMiddleware, schemaMiddleware);
